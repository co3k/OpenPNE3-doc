...
Session Hijaking (あとで攻撃手法と文章化、理由の説明をする)
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

* セッション ID は推測可能であってはいけない
* セッション ID はユーザ毎に固定値であってはいけない
* セッション ID が漏洩しないように気を配らなければいけない

Session Fixation (あとで攻撃手法と文章化、理由の説明をする)
+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

* ログインのたびにセッションを破棄し、新しいもののみを用いるようにすること
